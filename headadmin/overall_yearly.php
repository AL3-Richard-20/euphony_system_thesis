				...
				<div class="panel-header">
					...
					<div class="row">
						...
						<div class="col-sm-4"><br>
		              	...
		              	<div class="col-sm-4">
		              		<center><h3 class="cap">Yearly Overall Sales</h3><p>(<?php echo $branch_desc; ?>)</p></center><br>
		              	</div>
										...
										<?php
											...
											while($row = mysqli_fetch_assoc($query_sales)){
							    				...
							    				if($trans_date != date('Y-m-d')){
				  									...
				  									<a href="#" title="Delete" class="btn btn-danger btn-sm" onclick="deleting('delete_action.php?yearlyprodsalesid=<?php echo $sales_Id; ?>&branchid=<?php echo $branch_id; ?>');">Delete</a>
										...
										<?php
											...
											while($row = mysqli_fetch_assoc($query_payments)){
												...
												if($trans_date != date('Y-m-d')){
				  									...
				  									<a href="#" title="Delete" class="btn btn-danger btn-sm" onclick="deleting('delete_action.php?yearlylesssalesid=<?php echo $trans_Id; ?>&branchid=<?php echo $branch_id; ?>');">Delete</a>
