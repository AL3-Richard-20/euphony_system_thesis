...
<html lang = "en">
  	...
  	<head>
		...
		<!---Header END--->
  		...
  		<title>Euphony | Service Image</title>
  	...
  	<body>
  		...
  		<?php 
			...
			if($_GET['serviceimg'] != NULL){

				$service_img = $_GET['serviceimg'];
			}
			else{
				$service_img = "";
			}
						...
						<div class = "panel-body">
							...
							<?php
								...
								if($service_img != NULL){
									...
									echo "<center><img src='../images/services/$service_img' alt='photo' id='upload-demo' class='img-responsive'></center>";
						...
						<div class="panel-footer">
							...
							<?php 
								...
								if(isset($service_img)){
									...
									<center><button type="submit" class="btn btn-success btn-lg service_image_btn">Save</button> 


									<button type="button" class="btn btn-default btn-lg" onclick="location.href='edit_services.php?serviceid=<?php echo $last_id; ?>';">Cancel</button></center>
									...
									<center><button type = "submit" class = "btn btn-success btn-lg service_image_btn">Save</button></center>
		...
		<script type="text/javascript">
			...
			$('.service_image_btn').on('click', function (ev) {
				    ...
				    $.ajax({
				        ...
				        success: function (data) {
				        	...
				        	if(result == '1'){
				        		...
				        		sweetAlert('success', 'Saved Successfully', '', 'services.php?active=services');
