...
<html lang = "en">
	...
	<head>
    	...
    	<title>Euphony | Edit Service</title>
	...
	<body>
		...
		<?php
			...
			if(isset($_GET['serviceid'])){
				...
				$query = "SELECT * FROM services_tbl WHERE service_Id = '{$service_id}'";

	  			$query_services = mysqli_query($con, $query);
		    ...
		    if(isset($_POST['service_content'])){
		    	...
		    	$service_desc	    = escape($_POST['service_desc']);
		    	$service_content 	= escape($_POST['service_content']);
		    	$service_price 		= escape($_POST['service_price']);

				$query = "UPDATE services_tbl SET ";
				$query .= "title = '{$service_desc}', ";
				$query .= "price = '{$service_price}', ";
				$query .= "content = '{$service_content}' ";
				$query .= "WHERE service_Id = '{$service_id}'";

				$query_update_service = mysqli_query($con, $query);

				confirmQuery($query_update_service);

				echo "<script>sweetAlert('success', 'Successfully Updated', 'You updated a service', 'services.php?active=services');</script>";
	          		...
	          		<div class="panel panel-default">	
	          			...
	          			<div class="panel-header">
	          				...
	          				<div class="row">
					            ...
					            <div class="col-sm-4">
					                ...
					                <button type="button" class="btn btn-default btn-lg" style="float: left" onclick="location.href='services.php#services_sec'"><span class="fas fa-arrow-left"></span></button>

					            </div>

					            <div class="col-sm-4">
					              <center><h3 class="cap">Edit Service</h3></center>
					            </div>
						...
						<div class='panel-body'>
							...
							<div class="col-sm-6">
								<div class="item">
									<p>Description:</p>
			                      	<input type = "text" class = "form-control" name = "service_desc" value = "<?php echo $service_title; ?>" required="required">
			                    </div>
			                </div>
			                ...
			                <div class="col-sm-6">
			                    <div class="item">
		                      		<p>Price:</p>
		                      		<input type = "text" class = "form-control" name = "service_price" value = "<?php echo $service_price; ?>" required="required">
		                      	</div>
		                    </div>
		                    ...
		                    <div class="col-sm-12">
								<div class="item">
									<p>Content:</p>
					                <textarea class="form-control" name="service_content" id="service_content" rows="10" onKeyDown="limitText(this.form.service_content, 928, 929)" required="required"><?php echo $service_content; ?></textarea>
					            </div>
						...
						<div class='panel-body'>
	    					...
	    					<?php
								...
								if($service_image == NULL){
									echo "<img src = '../images/default/services_raw.jpg' class = 'img-responsive' id = 'image'>";
								}
								else{
									 echo "<img src = '../images/services/$service_image' class = 'img-responsive' id = 'image'>";
								}
    						...
    						<button type="button" class="btn btn-primary" onclick="location.href='add_service_image.php?serviceid=<?php echo $service_id; ?>&serviceimg=<?php echo $service_image; ?>'">Edit Image</button>
