				...
				<div class ="col-sm-6">	
					...
					<div class = "panel panel-default">
						...
						<div class = "panel-body">
							...
							<?php
								...
								if($lessimg != NULL){
									...
									echo "<center><img src='../images/lessons/Cover/$lessimg' alt='photo' id='upload-demo' class='img-responsive'></center>";
								}
						...
						<div class="panel-footer">
							...
							<center><button type='submit' class='btn btn-success btn-lg lesson_image_btn'>Save</button>
			      ...
			      size: 'viewport'
				    ...
				    $.ajax({
				        ...
				        success: function (data) {
				        	...
				        	if(result == '1'){
				        		sweetAlert('success', 'Saved Successfully', '', 'edit_lessons.php?lessonid='+ last_id +' ');
				        	}
