...
<html lang = "en">
  	...
  	<head>
		...
		<!---Header END--->
  		...
  		<title>Euphony | Edit Branch Image</title>
  	...
  	<body>
  		...
  		<?php 
			...
			if($_GET['branchimg'] != NULL){

				$branch_img = $_GET['branchimg'];
			}
			else{
				$branch_img = "";
			}
				...
				<div class ="col-sm-6">	
					...
					<div class = "panel panel-default">
						...
						<div class = "panel-body">
							...
							<?php
								...
								if($branch_img != NULL){
									...
									echo "<center><img src='../images/branches/$branch_img' alt='photo' id='upload-demo' class='img-responsive'></center>";
						...
						<div class="panel-footer">
							...
							<center><button type = "submit" class = "btn btn-success btn-lg branch_image_btn">Save</button>

							<button type="button" class="btn btn-default btn-lg branch_image_btn" onclick="location.href='edit_branches.php?branchid=<?php echo $last_id; ?>';">Cancel</button></center>
				    ...
				    $.ajax({
				        ...
				        success: function (data) {
				        	...
				        	if(result == '1'){
				        		...
				        		sweetAlert('success', 'Successfully Updated', 'You updated a branch', 'branches.php');
				        	}
