...
<html lang = "en">
	...
	<head>
		...
		<link rel = "stylesheet"  type="text/css" href = "../includes/style.css">
  		...
  		<title>Euphony | Edit Profile</title>
		...
		<div class = "container">
			...
			<?php 
				...
				if(isset($_POST['lastname'])){
					...
					$query .="First_name = '{$new_first_name}', Middle_name = '{$new_middle_name}', ";
					$query .="Sex = '{$new_sex}', Address = '{$new_address}', ";
					$query .="Contact_no = '{$new_contact_no}', Age = {$new_age}, ";
					$query .="Birthdate = '{$new_birthdate}', Nationality = '{$new_nationality}' ";
					...
					if($update_stud_profile == 1){
						echo "<script>sweetAlert('success', 'Successfully Updated', 'Profile was updated', 'view_profile.php?userid=$user_id');</script>";
					}
						...
						<div class = "col-sm-3">
							...
							<div class="item">
		            			...
		            			<div class="row">
		            				...
		            				<div class="col-sm-6">
		            					<a href="headadmin_account_settings.php?userid=<?php echo $user_id; ?>" class = "btn btn-default"><span class = "fa fa-cog"></span> Account</a>
		            				</div>
		            	...
		            	<div class = "col-sm-3">
		           		...
		           		<div class = "col-sm-3">
		           			<div class="item">
								<label>
		           					<p>Contact Number: </p>
		           					<input type = "number" class = "form-control" name = "contactno" value = "<?php echo $contactno; ?>" id="contactno" required="required">
		           				</label>
		           			</div>
		            	</div>
