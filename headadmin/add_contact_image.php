...
<html lang = "en">
  	...
  	<head>
		...
		<!---Header END--->
  		...
  		<title>Euphony | Branch Image</title>
  	...
  	<body>
				...
				<div class ="col-sm-6">	
					...
					<div class = "panel panel-default">
						...
						<div class = "panel-body">
							...
							<?php
								...
								if($branch_img != NULL){
									...
									echo "<center><img src='../images/contact/$branch_img' alt='photo' id='upload-demo' class='img-responsive'></center>";

								}

								else if(!isset($branch_img)){
									...
									?>
										...
										<center><img src="../images/default/contact_raw.jpg" alt="photo" id="upload-demo" class="img-responsive"></center>
						...
						<div class="panel-footer">
							...
							<center><button type = "submit" class = "btn btn-success btn-lg contact_image_btn">Save</button>
		...
		<script type="text/javascript">
			...
			$('.contact_image_btn').on('click', function (ev) {
				    ...
				    $.ajax({
				        ...
				        success: function (data) {
				        	...
				        	if(result == '1'){
				        		...
				        		sweetAlert('success', 'Saved Successfully', '', 'branches.php');
