...
<html lang = "en">
	...
	<head>
		...
		<title>Euphony | Lesson Sales</title>
				...
				<div class="panel-body">
					...
					<div class="row">
			  		...
			  		<div class="row">
			  			...
			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='payments.php';">
			  					<center><h3>Daily Sales</h3></center>
			  				</div>
			  			</div>

			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='monthly_lesson_sales.php';">
			  					<center><h3>Monthly Sales</h3></center>
			  				</div>
			  			</div>

			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='yearly_lesson_sales.php';">
