  		...
  		<div class="container-fluid">
	  		...
	  		<?php 
				...
				if(isset($_GET['userid'])){
					...
					// $query_profile_pic = adminProfile($user_id);
				...
				if(isset($_GET['profileimg'])){
					...
					$the_profile_img = $_GET['profileimg'];
				}
								...
								<label>
									...
									<?php
										...
										if($the_profile_img == NULL){
											...
											echo "<center><img src = '../images/profile_img/".$the_profile_img."' class = 'img-circle img-responsive' alt = 'photo' id = 'upload-demo' name = 'image'></center>";
										}
						...
						$.ajax({
							...
							success: function(data) {
								...
								if(result == '1'){
									...
									sweetAlert('success', 'Saved Successfully', 'You updated your profile picture', 'index.php');
								}
