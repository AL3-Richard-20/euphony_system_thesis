...
<html lang = "en">
	...
	<head>
		...
		<title>Euphony | Overall Sales</title>
				...
				<div class="panel-body">
					...
					<div class="row">
			  		...
			  		<div class="row">
			  			...
			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='overall_daily.php';">
			  					<center><h3>Daily Overall Sales</h3></center>
			  				</div>
			  			</div>

			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='overall_monthly.php';">
			  					<center><h3>Monthly Overall Sales</h3></center>
			  				</div>
			  			</div>

			  			<div class="col-sm-4">
			  				<div class="thumbnail" onclick="location.href='overall_yearly.php';">
			  					<center><h3>Yearly Overall Sales</h3></center>
			  				</div>
			  			</div>
