...
class myPDF extends FPDF{
    ...
    function tableHeader($con){
        ...
        $this->Cell(0, 10, 'CRITICAL STOCKS', 0, 0, 'C');
        $this->Ln(15);
    ...
    function criticalStocks($con){
		...
		$query .= "and PI.Branch_Id = '$the_branch_Id' and PI.Quantity <= $number ORDER BY P.Prod_Id ASC";

		$query_critical_stocks = mysqli_query($con, $query);
