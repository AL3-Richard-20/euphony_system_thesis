...
class myPDF extends FPDF{
    ...
    function tableHeader($con){
        ...
        $this->Cell(0, 10, 'FAST MOVING PRODUCTS', 0, 0, 'C');
        $this->Ln(15);
    ...
    function fastMovingProducts($con){
    	...
    	$query = "SELECT P.Prod_Id, P.Category_Id, P.Prod_brand, P.Prod_name, P.Prod_price, P.Prod_desc, ";
		  ...
		  $query .= "and SD.Prod_Id = P.Prod_Id ";
		  $query .= "and PI.Branch_Id = '$the_branch_Id' GROUP BY P.Prod_Id ORDER BY SUM(SD.Quantity) DESC";
