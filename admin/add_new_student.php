...
<html lang = "en">
	...
	<head>
		...
		<title>Euphony | Add New Student</title>
	...
	<body>
		...
		<?php 
			...
			if(isset($_POST['email'])){
            	...
            	$query1 = "INSERT INTO user_info_tbl(Branch_Id, Last_name, First_name, ";
            	$query1 .="Middle_name, Address, Contact_no, Birthdate, Age, Sex, ";
            	$query1 .="Nationality) ";
				$query1 .="VALUES('$branch_id', '$lastname','$firstname', ";
				$query1 .="'$middlename','$address','$mobileno','$birthdate', ";
				$query1 .="'$age', '$sex', '$nationality')";
				...
				if($add_student_info == 1){
					...
					$query2 = "INSERT INTO stud_status_tbl(User_Id, Status, ";
					$query2 .="Date_started) VALUES('$last_id', ";
					$query2 .="'Pending', curdate()) ";
	            ...
	            if($add_stud_status == 1){
	               	...
	               	$query3 = "INSERT INTO user_login(User_Id, Email, Password, ";
	               	$query3 .="Level, Date_started, vkey, createdate) ";
	               	$query3 .="VALUES('$last_id', '$email','$password', ";
	               	$query3 .="'Student', curdate(), '$vkey', now())";
	    ...
	    //         	$mail = new PHPMailer();
					...
					// if($mail->Send()){
						...
						echo "<script>location.href='add_profile_pic.php?userid=".$last_id."&sex=".$sex."&profileimg=';</script>";
					...
					<div class="panel-header">
						...
						<div class="row">
			              	...
			              	<div class="col-sm-4">
			              		...
			              		<center><h3 class="cap">Add New Student</h3></center>
					    	...
					    	<div class="tab-pane fade in active" id = "personal_information">
		      					...
		      					<div class = "row">
									...
									<div class = "col-sm-6 form-group">
										...
										<center>
											<button type="button" class="btn btn-default btn-lg" onclick="location.href='students.php';"><span>Back</span></button>
