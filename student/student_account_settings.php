...
<html lang = "en">
	...
	<head>
  	...
  	<body>
  		...
  		<?php include "includes/student_navigation.php"; ?><br><br><br>
  				...
  				if(isset($_POST['email'])){
			  		...
			  		if(password_verify($oldpass, $user_password)){
				  		...
				  		if($update_user_account == 1){
				  			echo "<script>formAlert('success', 'Successfully Updated!', 'Your account was updated', 'view_profile.php?userid=$the_user_id');</script>";
				  		}
				  	}
				  	else{

				  		echo "<script>sweetAlert('error', 'Cannot be done', 'Old password is invalid');</script>";	
  			...
  			<form method = "POST" novalidate>
	  			...
	  			<div class = "panel panel-default">
	  				...
	  				<div class="panel-footer">
					  	...
					  	<button type = "button" class = "btn btn-default btn-lg" onclick = "location.href='student_profile_settings.php?userid=<?php echo $the_user_id; ?>';">Cancel</button></center>
